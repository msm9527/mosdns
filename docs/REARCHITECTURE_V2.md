...
- CLI：`mosdns control`、`mosdns config validate`
- HTTP API：`/api/v1/control/*` 与现有业务资源域
...
mosdns control datasets list
mosdns control datasets verify
mosdns control datasets export
mosdns control requery jobs
mosdns control requery runs
mosdns control requery checkpoints
mosdns control requery prune
mosdns control shunt explain
mosdns control shunt conflicts
