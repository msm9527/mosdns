...
func (d *DomainSetLight) loadGeneratedRules(generatedFrom string) (data_provider.RuleExporter, []string, error) {
...
func (d *DomainSetLight) resolveGeneratedExporter(generatedFrom string) (data_provider.RuleExporter, bool, error) {
...
func (d *DomainSetLight) subscribeGeneratedSource(generatedFrom string, exporter data_provider.RuleExporter) {
	tag := strings.TrimSpace(generatedFrom)
	if tag == "" || exporter == nil {
		return
	}
	...
	exporter.Subscribe(func() {
		if err := d.reloadFromGeneratedSource(); err != nil && d.bp != nil {
			d.bp.L().Warn(
				"domain_set_light generated source reload failed",
...
func (d *DomainSetLight) reloadFromGeneratedSource() error {
	d.mu.RLock()
