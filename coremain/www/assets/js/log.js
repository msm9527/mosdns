...
const cacheManager = {
        ...
        async fetchStats(cache, signal) {
            try {
                const raw = await api.fetch(`/plugins/${cache.tag}/stats`, { signal });
