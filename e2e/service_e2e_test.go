...
func (fx *serviceE2EFixture) testRoutingModeSwitches(t *testing.T, rec *e2eCaseRecorder) {
	...
	requireServiceE2EARecord(t, proxyWhitelistResp, "30.0.0.2")
	fx.setSwitch(t, "client_proxy_mode", "all")
	rec.SetDetail("routing switches changed domestic realip/fakeip while localhost clients bypass client whitelist gating")
